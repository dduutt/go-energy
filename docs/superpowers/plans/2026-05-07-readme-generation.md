# README.md Generation Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Create a comprehensive README.md in Chinese for the go-energy project.

**Architecture:** A single markdown file following the "User Guide" style.
...
- [ ] **Step 1: Write the content for README.md**
...
```bash
git add README.md
git commit -m "docs: add comprehensive README.md in Chinese"
```
